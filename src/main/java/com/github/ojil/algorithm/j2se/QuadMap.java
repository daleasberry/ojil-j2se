...
public class QuadMap {
	...
	public QuadMap(Quad q1, Quad q2) throws com.github.ojil.core.Error {
		...
		this.t1 = new Triangle(q1.getCorner(0), q1.getCorner(1),
				q1.getCorner(2));
		this.t[0] = new TriangleMap(t1, new Triangle(q2.getCorner(0),
				q2.getCorner(1), q2.getCorner(2)));
		this.t2 = new Triangle(q1.getCorner(2), q1.getCorner(3),
				q1.getCorner(0));
		this.t[1] = new TriangleMap(t2, new Triangle(q2.getCorner(2),
				q2.getCorner(3), q2.getCorner(0)));
	}
