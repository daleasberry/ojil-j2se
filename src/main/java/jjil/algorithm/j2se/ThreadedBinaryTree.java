 ...
 *
 */
public class ThreadedBinaryTree<typeKey extends Comparable<typeKey>, typeValue> {
    ...
    public ThreadedBinaryTree(
    		typeKey key, 
    		ThreadedBinaryTree<typeKey,typeValue> thread) {
        this.key = key;
        this.right = thread;
     ...
     */
    public ThreadedBinaryTree<typeKey,typeValue> add(typeKey key) {
        ...
        if (n == 0) {
            ...
            if (this.left != null) {
                ...
                this.left = new ThreadedBinaryTree<typeKey,typeValue>(key, this);
                return this.left;
            }
        } else {
            ...
            if (this.right != null && !this.boolThread) {
                ...
                this.right = new ThreadedBinaryTree<typeKey,typeValue>(key, this.right);
     ...
     */
    public ThreadedBinaryTree<typeKey,typeValue> find(typeKey key) {
     ...
     * null if nothing does.
     */
    public ThreadedBinaryTree<typeKey,typeValue> findNearest(typeKey key) {
        int n = this.key.compareTo(key);
        if (n == 0) {
            ...
            if (this.right != null && !this.boolThread) {
                ...
                // right
                ThreadedBinaryTree<typeKey,typeValue> tbtRight = this.right.findNearest(key);
                if (tbtRight == null) {
                    return this;
                } else {
                    return tbtRight;
    ...
    public Vector<ThreadedBinaryTree<typeKey,typeValue>> inorderTraverse(
            ThreadedBinaryTree<typeKey,typeValue> end) {
        Vector<ThreadedBinaryTree<typeKey,typeValue>> v = new Vector<ThreadedBinaryTree<typeKey,typeValue>>();
     ...
     * null.
     */
    private Vector<ThreadedBinaryTree<typeKey,typeValue>> inorderTraverse(
            Vector<ThreadedBinaryTree<typeKey,typeValue>> v,
